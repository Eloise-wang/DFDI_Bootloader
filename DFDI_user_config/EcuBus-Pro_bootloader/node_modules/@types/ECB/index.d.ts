...
declare const serviceList: readonly [
        "Tester_1.*",
        "Tester_1.DiagnosticSessionControl160",
        "Tester_1.DiagnosticSessionControl161",
        "Tester_1.CommunicationControl400",
        "Tester_1.SecurityAccess390",
        "Tester_1.SecurityAccess391",
        "Tester_1.WriteDataByIdentifier460",
        "Tester_1.RequestDownload520_A",
        "Tester_1.RequestDownload520_B",
        "Tester_1.JobFunction0",
        "Tester_1.JobFunction1",
        "Tester_1.TransferData540",
        "Tester_1.RequestTransferExit550",
        "Tester_1.RoutineControl490",
        "Tester_1.RoutineControl491",
        "Tester_1.ECUReset170",
];
declare const allServicesSend: readonly [
        "Tester_1.*.send",
        "Tester_1.DiagnosticSessionControl160.send",
        "Tester_1.DiagnosticSessionControl161.send",
        "Tester_1.CommunicationControl400.send",
        "Tester_1.SecurityAccess390.send",
        "Tester_1.SecurityAccess391.send",
        "Tester_1.WriteDataByIdentifier460.send",
        "Tester_1.RequestDownload520_A.send",
        "Tester_1.RequestDownload520_B.send",
        "Tester_1.JobFunction0.send",
        "Tester_1.JobFunction1.send",
        "Tester_1.TransferData540.send",
        "Tester_1.RequestTransferExit550.send",
        "Tester_1.RoutineControl490.send",
        "Tester_1.RoutineControl491.send",
        "Tester_1.ECUReset170.send",
];
declare const allServicesRecv: readonly [
        "Tester_1.*.recv",
        "Tester_1.DiagnosticSessionControl160.recv",
        "Tester_1.DiagnosticSessionControl161.recv",
        "Tester_1.CommunicationControl400.recv",
        "Tester_1.SecurityAccess390.recv",
        "Tester_1.SecurityAccess391.recv",
        "Tester_1.WriteDataByIdentifier460.recv",
        "Tester_1.RequestDownload520_A.recv",
        "Tester_1.RequestDownload520_B.recv",
        "Tester_1.JobFunction0.recv",
        "Tester_1.JobFunction1.recv",
        "Tester_1.TransferData540.recv",
        "Tester_1.RequestTransferExit550.recv",
        "Tester_1.RoutineControl490.recv",
        "Tester_1.RoutineControl491.recv",
        "Tester_1.ECUReset170.recv",
];
...
interface Jobs {
    "Tester_1.JobFunction0": () => DiagRequest[]|Promise<DiagRequest[]>;
    "Tester_1.JobFunction1": () => DiagRequest[]|Promise<DiagRequest[]>;
}
/**
...
declare class UtilClass {
    ...
    constructor();
    /** @internal */
    private handleSerialPortData;
    /** @internal */
    private handleSerialPortError;
    /** @internal */
    private handleSerialPortClose;
    /**
 ...
 * @category SerialPort
 */
interface SerialPortCloseEvent {
    /** Serial port ID */
    id: string;
}
/**
 ...
 * ```
 */
declare class SerialPortClient extends Emittery<{
    data: Buffer;
    error: Error;
    close: undefined;
}> {
...
export { CAN_ADDR_FORMAT, CAN_ADDR_TYPE, CAN_ID_TYPE, CMAC, CRC, DiagJob, DiagRequest, DiagResponse, HexMemoryMap, LinChecksumType, LinDirection, LinMode, RegisterEthVirtualEntity, S19MemoryMap, SecureAccessDll, SerialPortClient, SomeipMessageRequest, SomeipMessageResponse, Util, UtilClass, after, afterEach, before, beforeEach, index_d as canopen, describe, fingerprintFromCanMessages, fuzz, getFrameFromDB, getCheckSum as getLinCheckSum, getPID, getSignal, getVar, linBaudRateCtrl, linPowerCtrl, linStartScheduler, linStopScheduler, output, registerWorker, reporter, runUdsSeq, setPwmDuty, setSignal, setTxPending, setVar, setVars, stopUdsSeq, test, workerEmit };
export type { AuthenticationSession, AuthenticationSessionAccountInformation, CRCName, CanAddr, CanFingerprint, CanMessage, CanMsgType, Signal as CanSignal, EntityAddr, EthAddr, FuzzContext, FuzzOptions, JobName, LinAddr, LinCableErrorInject, LinMsg, LinSignal, SerialPortCloseEvent, SerialPortDataEvent, SerialPortErrorEvent, SerialPortInfo, SerialPortOptions, SerialPortSetSignals, SerialPortSignals, ServiceEvent, ServiceId, ServiceItem, ServiceName, ServiceNameRecv, ServiceNameSend, SignalName, TesterInfo, TesterName, UdsAddress, UdsSeqName, VariableMap };
