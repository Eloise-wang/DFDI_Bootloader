...
#ifndef APP_BOOTLOADER_EXCHANGE_INFO_PUBLIC_INC_TOOLCHAIN_H_
#define APP_BOOTLOADER_EXCHANGE_INFO_PUBLIC_INC_TOOLCHAIN_H_
...
#endif /* APP_BOOTLOADER_EXCHANGE_INFO_PUBLIC_INC_TOOLCHAIN_H_ */
